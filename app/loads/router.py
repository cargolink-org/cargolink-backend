"""
loads — FastAPI router stub (Task A.2).
...
Endpoints (technical spec Sec. 5): POST /loads, GET /loads/{id}, POST /loads/{id}/accept
"""
...
async def loads_stub():
    ...
    B-H) is implemented."""
    raise HTTPException(status_code=501, detail={"error": {"code": "not_implemented", "message": "loads endpoints not implemented yet"}})
