"""
profiles — FastAPI router stub (Task A.2).
...
Endpoints (technical spec Sec. 5): GET /profiles/me, PUT /profiles/shipper, PUT /profiles/transporter
"""
...
async def profiles_stub():
    ...
    B-H) is implemented."""
    raise HTTPException(status_code=501, detail={"error": {"code": "not_implemented", "message": "profiles endpoints not implemented yet"}})
